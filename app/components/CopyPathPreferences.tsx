...
export function CopyPathPreferences({
  ...
  return (
    <div className="p-4 flex flex-col space-y-4">
      <h1 className="text-2xl text-gray-800 dark:text-white">Copy Path Preferences</h1>
      <div className="grid grid-cols-2 gap-4">
        <div className="max-w-xs">
          <label htmlFor="language" className="text-gray-800 dark:text-white">
            Language
          </label>
          <label htmlFor="variable-name" className="text-gray-800 dark:text-white">
            Variable Name
          </label>
          { canUseOptChaining[preferences.language || languages.javascript] &&
          <label htmlFor="use-optional-chaining" className="text-gray-800 dark:text-white">
        ...
        <div>
          <select
            ...
            onChange={(e) =>
              setPreferences({ ...preferences, language: e.target.value as languages })
            }
          >
