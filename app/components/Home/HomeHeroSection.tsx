...
export function HomeHeroSection() {
  return (
    <div
      className={`flex items-stretch bg-indigo-900 p-6 pb-16 pt-32 md:pt-32`}
    >
      <div className={`flex flex-col md:flex-row`}>
        <div className="self-center mt-6 md:pr-10">
        ...
        <div className="self-center flex align-center md:w-1/2 mt-8 lg:mt-0">
          <div className="max-w-lg">
            ...
            <SmallSubtitle className="text-slate-400 mb-8">
              ...
              staring at thousand line JSON files in your browser. With a few
              nice features to help make it not <em>the worst</em>.
            </SmallSubtitle>
            <NewFile />
          </div>
        </div>
